...
[d] a delegated todo @assignee(Leah) @anotherBooleanAttr`))
    ...
    it("should load in progress todo from subfolder", () => should(todos).containEql({ status: TodoStatus.InProgress, text: "An in progress todo", file: "ROOT|PROJECTS|2020-01-02 - Something|file2.md", folderType: "current", project: "2020-01-02 - Something", attributes: {}, line: 0 }))
    it("should load delegated todo from subfolder", () => should(todos).containEql({ status: TodoStatus.Delegated, text: "a delegated todo", file: "ROOT|PROJECTS|2020-01-02 - Something|file2.md", folderType: "current", project: "2020-01-02 - Something", attributes: { assignee: "Leah", anotherBooleanAttr: true }, line: 4 }))
    it("should move task to the corresponding project when specified", () => should(todos).containEql({ status: TodoStatus.Todo, text: "A todo for another project", file: "ROOT|PROJECTS|2020-01-02 - Something|file3.md", folderType: "current", project: "2020-03-03 - Another project", attributes: { project: "2020-03-03 - Another project" }, line: 0 }))
    it("loads attributes", () => {
